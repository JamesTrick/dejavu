...
class Portfolio:
    ...
    def underlying_view(self) -> dict[str, dict[str, Any]]:
        ...
        for sym, pos in self._positions.items():
            ...
            if inst.asset_class == AssetClass.EQUITY:
                ...
                equity_position = (
                    ...
                    and eq_pos.instrument.asset_class == AssetClass.EQUITY
                    else None
                )
                view.setdefault(
                    u,
        ...
        # Back-fill equity positions for underlyings only seen via options
    ...
    def update_prices(self, event: MarketEvent):
        ...
        if sym in self._positions:
            ...
            self._position_value += (
                (new_price - old_price) * pos.quantity * pos.instrument.multiplier
            )
    ...
    def _expire_options(self, current_date: date):
        ...
        for sym, pos in expired:
            ...
            self._position_value -= (
                pos.quantity
                * self._last_prices.get(sym, pos.avg_cost)
                * inst.multiplier
            )
    ...
    def apply_fill(self, fill: FillEvent):
        ...
        if sym in self._positions:
            ...
            self._position_value -= (
                pos.quantity * market_price * pos.instrument.multiplier
            )
            ...
            self._position_value += (
                new_pos.quantity * market_price * new_pos.instrument.multiplier
            )
